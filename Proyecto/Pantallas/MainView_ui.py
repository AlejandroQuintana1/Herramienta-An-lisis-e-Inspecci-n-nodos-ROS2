...
from PyQt5.QtWidgets import QSizePolicy,QTableWidgetItem,QTableWidget
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Indice.addItems(['Topic','Node','Service','Param','Gráfico'])
        ...
        self.textEdit2.setMaximumSize(QtCore.QSize(16777215, 150))
        ...
        self.Limpiar = QtWidgets.QMenu(self.menubar)
        self.Limpiar.setObjectName("Limpiar")

        self.Recargar = QtWidgets.QMenu(self.menubar)
        ...
        self.Archivo.addAction(self.actionGuardar)
        self.Limpiar.addAction(self.actionRecargar)
        self.Limpiar.addAction(self.actionLimpiar)
        self.menubar.addAction(self.Archivo.menuAction())
        self.menubar.addAction(self.Limpiar.menuAction())
        self.menubar.addAction(self.Recargar.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Limpiar.setTitle(_translate("MainWindow", "Ejecutar"))
        self.Recargar.setTitle(_translate("MainWindow", "Estilos"))
    ...
    def clean(self):
        self.verticalLayout_2.removeWidget(self.textEdit2)
        self.clean_table()
        self.textEdit.clear()
    ...
    def ejecutarComando(self):
        if self.checkCmd.isChecked():
            ...
            salida = subprocess.check_output(self.textEdit3.toPlainText(), shell= True, universal_newlines= True)
            self.verticalLayout_2.addWidget(self.textEdit2)
            self.textEdit2.clear()
