...
class TopicThread(QThread):
    ...
    def topicEcho(self,topic):
        reply = QMessageBox.question(None, 'Aviso','Al seleccionar esta opción se desplegará una termianl en la que visualizar la ejecucion del comando. ¿Desea continuar? \n Para finalizar ctrl+c',
